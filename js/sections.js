...
import { Trajectory } from './trajectory.js';
  ...
  const EXPERIENCE_DATA = [
    ...
    },
    {
      ...
      type:      'cert',
      typeLabel: 'En Curso',
      desc:      'Programa de certificación en ciberseguridad de IBM SkillsBuild. Operaciones de seguridad (SOC), análisis de amenazas, SIEM, respuesta a incidentes y forense digital básico.',
      ...
      highlights: [
        ...
        'Respuesta a incidentes y forense digital — en curso, finalización May 2026',
      ],
      metricas: [
        { label: 'Emisor', value: 'IBM' },
        { label: 'Estado', value: 'En curso' },
        { label: 'Fin est.', value: 'May 2026' },
      ],
    },
  ];
